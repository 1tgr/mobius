/* $Id: stat.h,v 1.1.1.1 2002/12/31 01:26:22 pavlovskii Exp $ */
...
int	mkdir(const char *_path, unsigned _mode);
int	mkfifo(const char *_path, unsigned _mode);
...
int		mknod(const char *_path, unsigned _mode, int _dev);
