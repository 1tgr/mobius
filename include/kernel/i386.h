...
/*
static __inline void i386_lpoke32(addr_t addr, uint32_t val)
{
	__asm__("movl %0, %%gs:(%1)" : : "g" (val), "g" (addr));
}

static __inline uint32_t i386_lpeek32(addr_t addr)
{
	uint32_t ret;
	__asm__("movl %%gs:(%1), %0" : "=r" (ret) : "g" (addr));
	return ret;
}
*/
