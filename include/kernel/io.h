/* $Id: io.h,v 1.2 2003/06/05 21:58:16 pavlovskii Exp $ */
...
status_t IoRequest(const io_callback_t *cb, device_t *dev, struct request_t *req);
status_t IoRequestSync(device_t *dev, struct request_t *req);
