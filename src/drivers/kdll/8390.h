...
struct _packet_hdr_t
{
    byte Status;           /* See RSR_* constants */
    byte NextPacket;       /* Pointer to next packet in chain */
    word PacketLength;    /* Length of packet including this header */
};
