...
# ADD LINK32 ..\crt0.obj /nologo /base:"0x40000000" /subsystem:console /machine:I386 /nodefaultlib /section:.info,r
...
# ADD LINK32 ..\crt0.obj /nologo /base:"0x40000000" /subsystem:console /incremental:no /debug /debugtype:coff /machine:I386 /nodefaultlib /pdbtype:sept /section:.info,r
# SUBTRACT LINK32 /pdb:none
